...
export var series = [
    ...
    new Serie(6, "A Very English Scandal", "BBC", 2, "A Very English Scandal is a fact-based three-part British television comedy-drama miniseries based on John Preston's book of the same titulo.", "https://www.bbc.co.uk/programmes/p065smy4", "https://i.imgur.com/D4y3DrQ.jpg"),
];
var seriesTable = document.getElementById("series");
var promedioTemporadasElemento = document.getElementById("totalPromedio");
...
function mostrarSeries(series) {
    ...
    var _loop_1 = function (serie) {
        ...
        var tdtitulo = trElement.querySelector('td:nth-child(2)');
...
function displayCard(serie) {
    var cardTitulo = document.querySelector('.card-Name');
    var cardTexto = document.querySelector('.card-Sinopsis');
    var cardImg = document.querySelector('.card-ImageOnTop');
    var cardenlace = document.querySelector('.card-link');
...
function getPromedioTemporadas(series) {
    ...
    var totalSeries = series.length; // Update the totalSeries variable to the length of the series array
    var rtaFinal = 0;
    ...
    promedioTemporadasElemento.innerHTML = "".concat(rtaFinal);
}
